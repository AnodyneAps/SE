//be counter
let domTopIdnl = document.getElementById('se___js-counter');
if (domTopIdnl !== null) {
...
function calculateDeliveryTimeEveryDay(someId, currentDate, setTime) {
	...
	function tick() {
        ...
        <div class="timer__text">
			   Vi skickar idag - Beställ före:
        </div>
        <div class="timer__counter">  
        <span class="time-go">
        <span class="time-hour"> <strong>${hours} </strong><span class="time__badge">Timmar</span></span> <code>:</code> 
        <span class="time-min"> <strong>${min}</strong><span class="time__badge">Minuter</span></span> <code>:</code> 
        ...
        someId.innerHTML = `<div class="timer__wrapper">
        <div class="timer__text">
        Vi skickar imorgon - Beställ före:
        </div>
        <div class="timer__counter">
        <span class="time-up"  >
        <span class="time-hour"> <strong>${hours} </strong><span class="time__badge">Timmar</span></span> <code>:</code>  
...
function calculateDeliveryTimeFriday(someId, currentDate, setTime) {
	...
	function tick() {
        ...
        <span class="time-sec"> <strong>${sec}</strong><span class="time__badge">Sekunder</span></span> 
			...
			someId.innerHTML = `<div class="timer__wrapper"><div class="timer__text">Gratis leverans | Gratis returer och byte.</div></div>`;
...
function calculateDeliveryTimeSaturday(someId) {
    someId.innerHTML = `<div class="timer__wrapper"><div class="timer__text">Gratis frakt vid köp över 595 SEK</div></div>`;
}
