...
s = addZero(secs - mins * 60);
  ...
  if(d<1){
    someId.innerHTML = `
  <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">immar</span></span></div>
  <div class="announcement_number"><span class="digit">${m}</span><span class="announcement_text">M<span class="hide-small">inuter</span></span></div>
  ...
  `
   ...
   someId.innerHTML = `
  <div class="announcement_number"><span class="digit">${d}</span><span class="announcement_text">D<span class="hide-small">agar</span></span></div>
  <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">immar</span></span></div>
  <div class="announcement_number"><span class="digit">${m}</span><span class="announcement_text">M<span class="hide-small">inuter</span></span></div>
  <div class="announcement_number"><span class="digit">${s}</span><span class="announcement_text">S<span class="hide-small">ekunder</span></span></div>
  `
